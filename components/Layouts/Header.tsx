    ...
    return (
        <header className={`z-40 ${themeConfig.semidark && themeConfig.menu === 'horizontal' ? 'dark' : ''}`}>
            <div className="shadow-sm">
                <div className="relative flex w-full items-center bg-white pr-2.5 dark:bg-black justify-between">
                    <div className="horizontal-logo flex items-center  lg:hidden">
                        <Link href="/" className="main-logo flex shrink-0 items-center">
                            <img className="inline w-40 ltr:-ml-1 rtl:-mr-1" src="/assets/images/logo.png" alt="ViewAnalyzer" />
                        </Link>
                    </div>
                    ...
                    <div className="flex items-center space-x-1.5 dark:text-[#d0d2d6] sm:rtl:mr-0 ">
                        <div className="flex items-center sm:ltr:mr-auto sm:rtl:ml-auto gap-2">
                            {/* header */}
                        ...
                        <div className="flex">
                            ...
                            <button type="button" className="btn btn-success btn-md ml-2">
                                Login
                            </button>
                        </div>
                    </div>
